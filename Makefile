#############################################################################
# Makefile for building: BlueDragon-Qt.app/Contents/MacOS/BlueDragon-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Feb 26 00:37:29 2017
# Project:  BlueDragon-qt.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP=1 USE_QRCODE=1 RELEASE=1 -o Makefile BlueDragon-qt.pro
#############################################################################
...
CC            = clang
CXX           = clang++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -O2 -arch x86_64 -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -fstack-protector-all --param ssp-buffer-size=1 -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2 -arch x86_64 -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/local/Cellar/qt/4.8.7_3/mkspecs/unsupported/macx-clang-libc++ -I/usr/local/Cellar/qt/4.8.7_3/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtNetwork.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtNetwork.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/include -Isrc -Isrc/json -Isrc/qt -I/usr/local/Cellar/miniupnpc/2.0/include -Isrc/leveldb/include -Isrc/leveldb/helpers -I/usr/local/Cellar/boost@1.55/1.55.0_1/include -I/usr/local/Cellar/berkeley-db@4/4.8.30/include -I/usr/local/Cellar/openssl-1.0.2j/include -I/usr/local/Cellar/qrencode/3.4.4/include -Ibuild -Ibuild -F/usr/local/Cellar/qt/4.8.7_3/lib
LINK          = clang++
...
LIBS          = $(SUBLIBS) -F/usr/local/Cellar/qt/4.8.7_3/lib -L/usr/local/Cellar/qt/4.8.7_3/lib -static-libstdc++ -lqrencode -L/usr/local/opt/miniupnpc/lib -lminiupnpc /Volumes/MacOSX/github/bluedragoncoin/src/leveldb/libleveldb.a /Volumes/MacOSX/github/bluedragoncoin/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -L/usr/local/opt/boost155/lib -L/usr/local/Cellar/berkeley-db4/4.8.30/lib -L/usr/local/Cellar/openssl-1.0.2j -L/usr/local/opt/qrencode/lib -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -framework QtGui -L/usr/local/opt/openssl/lib -L/usr/local/Cellar/qt/4.8.7_3/lib -F/usr/local/Cellar/qt/4.8.7_3/lib -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /usr/local/Cellar/qt/4.8.7_3/mkspecs/common/unix.conf \
		...
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/static.prf \
		...
		BlueDragon-qt.pro
QMAKE_TARGET  = BlueDragon-Qt
DESTDIR       = 
TARGET        = BlueDragon-Qt.app/Contents/MacOS/BlueDragon-Qt
...
all: Makefile BlueDragon-Qt.app/Contents/PkgInfo BlueDragon-Qt.app/Contents/Resources/empty.lproj BlueDragon-Qt.app/Contents/Info.plist BlueDragon-Qt.app/Contents/Resources/BlueDragon.icns $(TARGET)

$(TARGET): /Volumes/MacOSX/github/bluedragoncoin/src/leveldb/libleveldb.a /Volumes/MacOSX/github/bluedragoncoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_blockbrowser.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) BlueDragon-Qt.app/Contents/MacOS/ || $(MKDIR) BlueDragon-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: BlueDragon-qt.pro  /usr/local/Cellar/qt/4.8.7_3/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.7_3/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/clang.conf \
		...
		/usr/local/Cellar/qt/4.8.7_3/lib/QtNetwork.framework/QtNetwork.prl
	$(QMAKE) USE_UPNP=1 USE_QRCODE=1 RELEASE=1 -o Makefile BlueDragon-qt.pro
...
BlueDragon-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) BlueDragon-Qt.app/Contents || $(MKDIR) BlueDragon-Qt.app/Contents 
	@$(DEL_FILE) BlueDragon-Qt.app/Contents/PkgInfo
	@echo "APPL????" >BlueDragon-Qt.app/Contents/PkgInfo
BlueDragon-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) BlueDragon-Qt.app/Contents/Resources || $(MKDIR) BlueDragon-Qt.app/Contents/Resources 
	@touch BlueDragon-Qt.app/Contents/Resources/empty.lproj
	
BlueDragon-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) BlueDragon-Qt.app/Contents || $(MKDIR) BlueDragon-Qt.app/Contents 
	@$(DEL_FILE) BlueDragon-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,BlueDragon.icns,g" -e "s,@EXECUTABLE@,BlueDragon-Qt,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.7_3/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >BlueDragon-Qt.app/Contents/Info.plist
BlueDragon-Qt.app/Contents/Resources/BlueDragon.icns: src/qt/res/icons/BlueDragon.icns
	@$(CHK_DIR_EXISTS) BlueDragon-Qt.app/Contents/Resources/ || $(MKDIR) BlueDragon-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) BlueDragon-Qt.app/Contents/Resources/BlueDragon.icns
	@$(COPY_FILE) src/qt/res/icons/BlueDragon.icns BlueDragon-Qt.app/Contents/Resources/BlueDragon.icns
dist: 
	@$(CHK_DIR_EXISTS) build/BlueDragon-Qt1.0.1 || $(MKDIR) build/BlueDragon-Qt1.0.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/coincontrol.h src/sync.h src/util.h src/uint256.h src/kernel.h src/scrypt.h src/pbkdf2.h src/serialize.h src/strlcpy.h src/main.h src/miner.h src/net.h src/key.h src/db.h src/txdb.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/bloom.h src/checkqueue.h src/hash.h src/hashblock.h src/limitedmap.h src/sph_blake.h src/sph_bmw.h src/sph_cubehash.h src/sph_echo.h src/sph_groestl.h src/sph_jh.h src/sph_keccak.h src/sph_luffa.h src/sph_shavite.h src/sph_simd.h src/sph_skein.h src/sph_fugue.h src/sph_hamsi.h src/sph_shabal.h src/sph_whirlpool.h src/sph_types.h src/threadsafety.h src/txdb-leveldb.h src/qt/blockbrowser.h src/qt/qrcodedialog.h src/qt/macdockiconhandler.h build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/txdb-leveldb.cpp src/bloom.cpp src/hash.cpp src/blake.c src/bmw.c src/cubehash.c src/echo.c src/groestl.c src/jh.c src/keccak.c src/luffa.c src/shavite.c src/simd.c src/skein.c src/fugue.c src/hamsi.c src/shabal.c src/whirlpool.c src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/miner.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-arm.S src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt.cpp src/pbkdf2.cpp src/qt/blockbrowser.cpp src/qt/qrcodedialog.cpp build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/forms/coincontroldialog.ui src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/blockbrowser.ui src/qt/forms/qrcodedialog.ui build/BlueDragon-Qt1.0.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/BlueDragon-Qt1.0.1/ && (cd `dirname build/BlueDragon-Qt1.0.1` && $(TAR) BlueDragon-Qt1.0.1.tar BlueDragon-Qt1.0.1 && $(COMPRESS) BlueDragon-Qt1.0.1.tar) && $(MOVE) `dirname build/BlueDragon-Qt1.0.1`/BlueDragon-Qt1.0.1.tar.gz . && $(DEL_FILE) -r build/BlueDragon-Qt1.0.1


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Volumes/MacOSX/github/bluedragoncoin/src/leveldb/libleveldb.a; cd /Volumes/MacOSX/github/bluedragoncoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r BlueDragon-Qt.app
	-$(DEL_FILE) Makefile


/Volumes/MacOSX/github/bluedragoncoin/src/leveldb/libleveldb.a: FORCE
	cd /Volumes/MacOSX/github/bluedragoncoin/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -fstack-protector-all --param ssp-buffer-size=1 -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Volumes/MacOSX/github/bluedragoncoin/build/build.h: FORCE
	cd /Volumes/MacOSX/github/bluedragoncoin; /bin/sh share/genbuild.sh /Volumes/MacOSX/github/bluedragoncoin/build/build.h
...
build/moc_blockbrowser.cpp: src/qt/clientmodel.h \
	...
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/blockbrowser.h -o build/moc_blockbrowser.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/BlueDragon.png \
		src/qt/res/icons/BlueDragonoverview.png \
		src/qt/res/icons/BlueDragon.png \
...
build/ui_blockbrowser.h: src/qt/forms/blockbrowser.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/blockbrowser.ui -o build/ui_blockbrowser.h
